...
\033[95m╰─────╯ ╰────╯\033[36m─────────╯\033[33m──────────╯\033[38;5;220m───╯\033[37m─────────╯\033[32m─────────╯\033[38;5;206m╯  ╰───╯""")
print(f"\033[97m╔{'═' * 66}╗")
print(f"\033[97m║\033[33m{' ' * 18}SCRIPT KHUSUS ATTACK ZI0NIST{' ' * 18}\033[0m║")
print(f"\033[97m║\033[33m{' ' * 17}TIDAK UNTUK WEBSITE PEMERINTAH {' ' * 16}\033[0m║")
print(f"\033[97m║\033[33m{' ' * 21}_BISI DORAKA MOYANG_{' ' * 22}\033[0m║")
print(f"\033[97m╚{'═' * 66}╝")
while attemps < 100:
