...
\033[95m╰─────╯ ╰────╯\033[36m─────────╯\033[33m──────────╯\033[38;5;220m───╯\033[37m─────────╯\033[32m─────────╯\033[38;5;206m╯  ╰───╯""")
print(f"\033[97m╔{'═' * 71}╗")
print(f"\033[97m║\033[33m{' ' * 21}SCRIPT KHUSUS ATTACK ZI0NIST{' ' * 20}\033[0m║")
print(f"\033[97m║\033[33m{' ' * 20}TIDAK UNTUK WEBSITE PEMERINTAH {' ' * 18}\033[0m║")
print(f"\033[97m║\033[33m{' ' * 24}_BISI DORAKA MOYANG_{' ' * 25}\033[0m║")
print(f"\033[97m╚{'═' * 71}╝")
while attemps < 100:
